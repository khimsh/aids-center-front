export const en = {
  nav: {
    ...
    instrumentalDiagnostics: 'Instrumental Diagnostics',
    scientificResearch: 'Scientific Research',
    laboratory: 'Laboratory',
    contact: 'Contact',
    getTested: 'Get Tested',
    aboutHivAids: 'About HIV/AIDS',
    epidemiologicalSituationStats: 'Epidemiological Situation & Statistics',
    prevention: 'Prevention',
    treatment: 'Treatment',
    livingWithHiv: 'Living with HIV',
    forProfessionals: 'For Professionals',
    etiopathogenesis: 'Etiopathogenesis',
    clinicalSpectrum: 'Clinical Spectrum',
    diagnostic: 'Diagnostic',
    palliativeCare: 'Palliative Care',
    importantDates: 'Important Dates',
    waysOfTransmission: 'Ways of Transmission',
